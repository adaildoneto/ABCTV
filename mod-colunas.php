...
<div class="row">
  ...
  <!--  <div class="colunista">
    <div class="center-align"><img align="center" class="circle  z-depth-1 img-coluna center-align" src="https://diariodoacre.com.br/wp-content/uploads/2019/04/FB_IMG_1554598089479-1-150x150.jpg"></div>
    ...
    <div class="colunista">
    <div class="center-align"><img align="center" class="circle  z-depth-1 img-coluna center-align" src="https://diariodoacre.com.br/wp-content/uploads/2019/11/WhatsApp-Image-2019-11-08-at-12.32.37-150x150.jpg"></div>

    <div class="row"><a href="http://diariodoacre.com.br/category/retrato-politico/"><h4 class=" news2 blue-grey-text text-darken-4 center-align" style="font-size: 1.2rem; font-weight: 800; padding: 5px;">De tudo um pouco</h4></a>
      <h6 class="blue-grey-text text-darken-4 center-align" style="font-size: 0.8rem; margin-top: -15px;">Retrato Político</h6></a>
      <?php
  ...
  <div class="colunista">
    ...
    <div class="row"><a href=""><h4 class=" news2 blue-grey-text text-darken-4 center-align" style="font-size: 1.2rem; font-weight: 800; padding: 5px;">Você sabia?</h4></a>
      <h6 class="blue-grey-text text-darken-4 center-align" style="font-size: 0.8rem; margin-top: -15px;">Anderson Siqueira</h6></a>
      <?php
